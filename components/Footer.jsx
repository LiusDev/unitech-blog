    ...
    <footer className='bg border-t border-sky-900 px-4 py-8 md:px-12 lg:px-16 relative bottom-0 left-0 right-0'>
        <div className='flex flex-col md:flex-row md:space-x-16 justify-center md:items-center items-start'>
                ...
                <div className='flex items-center space-x-3'>
                    ...
                    <a href="https://www.facebook.com/x.quy.203/" target="_blank">
                        <div>
                            ...
                            <p className='text-blue-400 font-semibold'>Đào Xuân Quý</p>
                        </div>
                    </a>
                </div>
                <div className='flex items-center space-x-3'>
            ...
            <div className='flex flex-col space-y-4 mb-3 md:mb-0'>
                ...
                <div className='flex items-center space-x-3'>
                    <div class="fb-page" data-href="https://www.facebook.com/unitym.fpt" data-tabs="" data-width="400" data-height="130" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
